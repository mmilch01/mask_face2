...
nrg_improc_tools="run_facemasking2_xnat mask_face_nomatlab cmpanalyze analyze2dcm dcm2analyze dcm_nii nii_img hdbet_wrapper dcm2nii2013 dcm2nii.ini xnat2loc "
